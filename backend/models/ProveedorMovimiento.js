...
const ProveedorMovimiento = sequelize.define("ProveedorMovimiento", {
  ...
  mercaderias_compradas: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
  dinero_ventas: { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0 },
